...
While csVIsuNet is the migrated version of VisuNet into Cytoscape. (https://cytoscape.org)
...
* The documentation reflects the previous version and not the current one!
